...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',  # <- from your psql command
        'USER': 'postgres',  # <- from your psql command
        'PASSWORD': 'BrvdWRNPIhXzbduODNEUFcpdENUzseiv',
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # optional in dev
...
AUTH_USER_MODEL = 'restaran.User'  # custom user
REST_FRAMEWORK = {
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=1),  # usually 1 day
}